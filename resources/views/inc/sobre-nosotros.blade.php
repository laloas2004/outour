...
<div class="row">
    <img src="{{url('/images/sobre-nosotros.jpg')}}" style="width: 100%;">
</div>
<div class="container">
    ...
    <div class="row col-md-10" style="margin-top:40px;font-size: 20px;text-align: justify;">
        ...
        <p>
            ...
            Esto sin olvidar, que ofertamos una atención personalizada, donde nuestra principal intención es ofrecer a nuestros socios experiencias maravillosas e inolvidables a través de expediciones de naturaleza, cultura y aventura.</p><p>
        </p><p> Buscamos en todo momento ser distinguido como el único club existente que pueda ofrecer a sus socios un precio preferencial en todo momento, garantizando, calidad, limpieza, puntualidad y muchísima diversión.
...
<div class="container">
    ...
    <div class="row col-md-10" style="margin-bottom: 40px;">
        ...
        <div class="" style="width: 50%; float: right;">
            <img src="{{url('/images/sobre-nosotros2.jpg')}}" class="" style=" float: right; width:400px;">
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row col-md-10">
        <h1>Nuestra Misión será siempre...</h1>
    </div></div>
<div class="container">
    <div class="col-md-1 "></div>
    <div class="row col-md-10" style="float: right;">
        <h1 style="text-align: right; margin-top:-5px; margin-right:125px; ">Diversión, ahorro y superación</h1>
    </div>
</div>
